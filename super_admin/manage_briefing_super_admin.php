...
if (isset($_POST['act_btn_briefing'])) {
    ...
    header('Location: manage_briefing_super_admin.php');
}
                                    ...
                                    <form action='' method='post'>
                                        <td class="text-center">
                                            ...
                                            if($briefingData2['ex_bd_lv_doc'] != '') { ?>
                                                ...
                                                <a href="ex_bd_lv_docs/<?php echo $briefingData2['ex_bd_lv_doc'] ?>" target="_blank">Download</a>
                                            <?php } else { ?>
                ...
                <div class="well">
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        <tr>
                            ...
                            <th class="text-center">BD of Group members</th>                           <th class="text-center">Forms</th>
                            <th class="text-center">Remarks</th>
                            <th class="text-center">Action</th>
                        </tr>
                        <?php $serial_number = 1;
