            ...
            <div class="col-md-8 col-md-offset-2">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li>
                            <?php if ($page > 1) { ?>
                                <a href="../super_admin/history_debrief_visit_super_admin.php?page=<?php echo $Previous; ?>">&laquo; Previous</a>
                            <?php } ?>
                        </li>
                        <li>
                            <a href="../super_admin/history_debrief_visit_super_admin.php?page=1">First page</a>
                        </li>
                        <li>
                            <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                <a href="../super_admin/history_debrief_visit_super_admin.php?page=<?php echo $i; ?>"><?php echo '<b>' . $i . '</b>'; ?></a>
                            <?php } ?>
                        </li>
                        <li>
                            <a href="../super_admin/history_debrief_visit_super_admin.php?page=<?php echo $pages; ?>">Last page</a>
                        </li>
                        <li>
                            <?php if ($page < $pages) { ?>
                                <a href="../super_admin/history_debrief_visit_super_admin.php?page=<?php echo $Next; ?>">Next &raquo;</a>
                            <?php } ?>
                        </li>
                    </ul>
                </nav>
