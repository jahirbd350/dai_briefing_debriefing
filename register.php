                ...
                <form class="form-horizontal" method="POST" action="" data-toggle="validator">
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group has-feedback">
                            <input type="text" pattern="[A-z_ ]{1,}$"
                                   data-pattern-error="No special character & number is allowed!" class="form-control"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group has-feedback">
                            <input type="password" id="password" data-minlength="6"
                                   data-error="Password minimum 6 character !" class="form-control"
                                   placeholder="Password" name="user_password" minlength="6" required>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group has-feedback">
                            <input type="password" data-match="#password"
                                   ...
                                   placeholder="Password" name="cf_user_password" minlength="6" required>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-offset-4 col-md-8">
                            <button type="submit" class="btn btn-success btn-block" name="btn_register">Register
                            </button>
                        </div>
                    </div>
                </form>
