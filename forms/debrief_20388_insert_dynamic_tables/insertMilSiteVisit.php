...
if (isset($_POST["mil_site_ser_no"])) {
    ...
    for ($count = 0; $count < count($mil_site_ser_no); $count++) {
        ...
        if ($mil_site_ser_no_clean != '' && $mil_site_place_clean != '' && $mil_site_importance_clean != '') {
            $query .= '
       INSERT INTO debrief_20388_military_site_visited(bd_no,visit_info_id,ser_no, place, importance) 
