            ...
            <div class="col-md-8 col-md-offset-2">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li>
                            <?php if ($page > 1) { ?>
                                <a href="history_briefing.php?page=<?php echo $Previous; ?>">&laquo; Previous</a>
                            <?php } ?>
                        </li>
                        <li>
                            <a href="history_briefing.php?page=1">First Page</a>
                        </li>
                        <li>
                            <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                <a href="history_briefing.php?page=<?php echo $i; ?>"><?php echo '<b>' . $i . '</b>'; ?></a>
                            <?php } ?>
                        </li>
                        <li>
                            <a href="history_briefing.php?page=<?php echo $pages; ?>">Last Page</a>
                        </li>
                        <li>
                            <?php if ($page < $pages) { ?>
                                <a href="history_briefing.php?page=<?php echo $Next; ?>">Next &raquo;</a>
                            <?php } ?>
                        </li>
                    </ul>
                </nav>
